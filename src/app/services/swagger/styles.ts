export const cssOptions = {
  customCss: `
    ...
    .swagger-ui, .swagger-ui section h3 { color: #FF9A76; }
    ...
    .swagger-ui .opblock-tag {
      ...
      border-bottom: 5px solid #65938B;
      color: #FF9A76;
    ...
    .swagger-ui section.models.is-open h4 { border-bottom: 5px solid #65938B; background-color: #1C213C; }
    ...
    .swagger-ui section.models h4 { background-color: #1C213C; border-bottom: 5px solid #65938B; color: #FF9A76; }
